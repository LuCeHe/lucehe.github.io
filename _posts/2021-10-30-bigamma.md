...
\begin{align*}
    BiGamma_X(x; \alpha, \lambda, \delta)=\begin{cases}
               \delta Gamma_X(x; \alpha, \lambda) &x>0\\
               (1-\delta)Gamma_X(-x; \alpha, \lambda) &otherwise
            \end{cases}
\end{align*}
$$
...
$$
\begin{align*}
    E_{Bigamma}X = &\int_{-\infty}^\infty x^2 Bigamma(x)dx\\
     = &\delta\int_{-\infty}^0 x Gamma(-x)dx + (1-\delta)\int_{0}^\infty x^2 Gamma(x)dx\\
     = &-\delta\int_{0}^\infty x Gamma(x)dx+ (1-\delta)\int_{0}^\infty x^2 Gamma(x)dx\\
     = &E_{Gamma}X^2\\
\end{align*}
$$
